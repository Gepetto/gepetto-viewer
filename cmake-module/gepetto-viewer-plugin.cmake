...
macro(GEPETTO_GUI_PLUGIN PLUGIN_NAME)
    ...
    if(DEFINED GEPETTO_VIEWER_INCLUDEDIR)
        set(MOC_INCLUDE_GEPETTO_VIEWER
            "-I${GEPETTO_VIEWER_INCLUDEDIR}"
            ${PLUGIN_MOC_OPTIONS}
        )
    ...
    if(PLUGIN_QT4)
        qt4_wrap_cpp(
            PLUGIN_HEADERS_MOC
            ${PLUGIN_HEADERS}
            OPTIONS ${MOC_INCLUDE_GEPETTO_VIEWER}
        )
    ...
    target_compile_definitions(
        ${PLUGIN_NAME}
        PRIVATE ${QT_DEFINITIONS} -DQT_PLUGIN -DQT_NO_DEBUG -DQT_SHARED
    )
    ...
    target_link_libraries(
        ${PLUGIN_NAME}
        PUBLIC ${QT_LIBRARIES} ${PLUGIN_LINK_DEPENDENCIES}
    )
...
macro(GEPETTO_GUI_PYPLUGIN file)
    ...
    file(
        GENERATE OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${file_md5}
        CONTENT "${file}\n${module}"
    )

    install(
        FILES ${CMAKE_CURRENT_BINARY_DIR}/${file_md5}
