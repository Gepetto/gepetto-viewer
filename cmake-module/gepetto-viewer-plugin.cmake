...
MACRO(GEPETTO_GUI_PLUGIN PLUGIN_NAME)
  ...
  IF(DEFINED GEPETTO_VIEWER_INCLUDEDIR)
    SET(MOC_INCLUDE_GEPETTO_VIEWER "-I${GEPETTO_VIEWER_INCLUDEDIR}" ${PLUGIN_MOC_OPTIONS})
  ...
  target_compile_definitions(${PLUGIN_NAME} PRIVATE ${QT_DEFINITIONS} -DQT_PLUGIN -DQT_NO_DEBUG -DQT_SHARED)
  ...
  TARGET_LINK_LIBRARIES(${PLUGIN_NAME} PUBLIC ${QT_LIBRARIES} ${PLUGIN_LINK_DEPENDENCIES})
