    ...
    if(${OPENSCENEGRAPH_VERSION} VERSION_GREATER "3.5.5")
        ...
        if(NOT DEFINED PROJECT_USE_QT4)
            if(EXISTS "${OPENSCENEGRAPH_OSGQT_INCLUDEDIR}/osgQt/Version")
                file(
                    READ "${OPENSCENEGRAPH_OSGQT_INCLUDEDIR}/osgQt/Version"
                    osgqt_version_content
                    LIMIT 500
                )
                string(
                    FIND ${osgqt_version_content}
                    "#define OSGQT_QT_VERSION 4"
                ...
                if(
                    osgqt_qt_version4_idx EQUAL -1
                    AND osgqt_qt_version5_idx EQUAL -1
                )
