...
/// \li \c Plugin.osgWidget when a new OSGWidget is created
/// (MainWindow::viewCreated(OSGWidget*)). \li \c Plugin.resetConnection
/// triggered when CORBA connection should be reset. **This is mandatory is you
/// have a CORBA Client** \li \c Plugin.refreshInterface triggered when users
/// request to refresh the interface.
///
/// ### Logging information
///
...
/// This is an example Python Plugin for \link hpp::gui::PythonWidget \endlink.
/// Two classes are defined: \b _NodeCreator and \b Plugin. Two signals are
/// used: \a mainWindow.refresh() and \a osgWidget. Load the widget with: \code
